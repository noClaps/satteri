...
fn err_esm_invalid() {
    assert_eq!(
        compile("import 1/1", &Default::default())
            ...
            .unwrap()
            .to_string(),
        "1:8: Could not parse esm with oxc: Expected `from` but found `decimal` (mdxjs-rs:oxc)",
...
fn err_expression_broken_multiline_comment_a() {
    assert_eq!(
        compile("{x/*}", &Default::default())
            ...
            .unwrap()
            .to_string(),
        "1:6: Could not parse expression with oxc: Unterminated multiline comment (mdxjs-rs:oxc)",
...
fn err_expression_broken_line_comment_b() {
    assert_eq!(
        compile("{//x}", &Default::default())
            ...
            .unwrap()
            .to_string(),
        "1:2: Could not parse expression with oxc: Unexpected empty expression (mdxjs-rs:oxc)",
...
fn err_esm_stmt() {
    assert_eq!(
        compile("export let a = 1\nlet b = 2", &Default::default())
            ...
            .unwrap()
            .to_string(),
        "2:10: Unexpected statement in code: only import/exports are supported (mdxjs-rs:oxc)",
...
fn err_expression_invalid() {
    assert_eq!(
        compile("{!}", &Default::default())
            ...
            .unwrap()
            .to_string(),
        "1:4: Could not parse expression with oxc: Unexpected token (mdxjs-rs:oxc)",
...
fn err_expression_multi() {
    assert_eq!(
        compile("{x; y}", &Default::default())
            ...
            .unwrap()
            .to_string(),
        "1:7: Could not parse expression with oxc: Unexpected content after expression (mdxjs-rs:oxc)",
...
fn err_expression_value_empty() {
    assert_eq!(
        compile("<a b={ } />", &Default::default())
            ...
            .unwrap()
            .to_string(),
        "1:7: Could not parse expression with oxc: Unexpected empty expression (mdxjs-rs:oxc)",
...
fn err_expression_value_invalid() {
    assert_eq!(
        compile("<a b={!} />", &Default::default())
            ...
            .unwrap()
            .to_string(),
        "1:12: Could not parse expression with oxc: Unexpected token (mdxjs-rs:oxc)",
...
fn err_expression_spread_multi_1() {
    assert_eq!(
        compile("<a {...x; y} />", &Default::default())
            ...
            .unwrap()
            .to_string(),
        "1:9: Could not parse expression with oxc: Expected `,` or `}` but found `;` (mdxjs-rs:oxc)",
...
fn err_expression_spread_invalid() {
    assert_eq!(
        compile("<a {...?} />", &Default::default())
            ...
            .unwrap()
            .to_string(),
        "1:13: Could not parse expression with oxc: Unexpected token (mdxjs-rs:oxc)",
