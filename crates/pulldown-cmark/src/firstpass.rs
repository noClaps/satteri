...
impl<'a, 'b> FirstPass<'a, 'b> {
    ...
    fn parse_mdx_esm(&mut self, start_ix: usize, end_ix: usize) -> usize {
    ...
    fn parse_mdx_jsx_flow(&mut self, start_ix: usize, end_ix: usize) -> usize {
    ...
    fn parse_mdx_flow_expression(&mut self, start_ix: usize, end_ix: usize) -> usize {
