//! `satteri-mdast` — MDAST-specific node types, codecs, and tree operations.
//!
//! Generic arena infrastructure lives in `satteri-arena`.
...
pub use codec::{
    ...
    decode_reference_data, encode_code_data, encode_definition_data, encode_expression_data,
    ...
    ListItemData, MathData, MdxJsxElementData, ReferenceData,
};
pub use codec::{
