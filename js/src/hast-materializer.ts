import {
  ...
  PROP_BOOL_TRUE, PROP_BOOL_FALSE,
  type HastProperty,
} from './hast-reader.ts';
...
export function materializeHastNode(
  ...
  let typeName: string;
  switch (nodeType) {
    case HAST_ROOT: typeName = 'root'; break;
    case HAST_ELEMENT: typeName = 'element'; break;
    case HAST_TEXT: typeName = 'text'; break;
    case HAST_COMMENT: typeName = 'comment'; break;
    case HAST_DOCTYPE: typeName = 'doctype'; break;
    case HAST_RAW: typeName = 'raw'; break;
    default: typeName = `unknown(${nodeType})`; break;
  }
  ...
  Object.defineProperty(node, 'data', {
    get() { return dataMap.get(nodeId); },
    set(value: Record<string, unknown>) { dataMap.set(nodeId, value); },
    configurable: true,
    enumerable: true,
  });
    ...
    case HAST_ROOT:
      ...
      Object.defineProperty(node, 'children', {
        get(this: HastNode) {
          ...
          Object.defineProperty(this, 'children', { value: children, writable: true, configurable: true, enumerable: true });
          return children;
        },
        configurable: true,
        enumerable: true,
