 ...
 */
function addTypeProperties(node: MdastNode, reader: ArenaReader, nodeId: number, nodeType: number): void {
  switch (nodeType) {
    case 2: // heading
    ...
    case 20: // footnoteReference
      Object.defineProperties(node, {
        ...
        referenceType: lazyProp('referenceType', () => reader.getReferenceData(nodeId).referenceType),
      });
      break;

    case 19: // footnoteDefinition
      Object.defineProperties(node, {
        identifier: lazyProp('identifier', () => reader.getFootnoteDefinitionData(nodeId).identifier),
