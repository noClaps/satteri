// Builds a minimal valid arena buffer in pure JS for testing ArenaReader
...
export const NodeType = {
  Root: 0, Paragraph: 1, Heading: 2, Text: 10, Link: 15,
} as const;
...
export function buildHelloWorldBuffer(): ArrayBuffer {
  ...
  const typeData = new Uint8Array([
    ...
    2, 0, 0, 0, 5, 0, 0, 0, // StringRef for "Hello": offset=2, len=5
    9, 0, 0, 0, 5, 0, 0, 0, // StringRef for "World": offset=9, len=5
  ]);

  return buildTestBuffer({
    source,
    nodes: [
      { id: 0, type: 0, parent: 0, startOffset: 0, endOffset: 14, startLine: 1, startColumn: 1, endLine: 2, endColumn: 6, childrenStart: 0, childrenCount: 2, dataOffset: 0, dataLen: 0 },
      { id: 1, type: 2, parent: 0, startOffset: 0, endOffset: 7, startLine: 1, startColumn: 1, endLine: 1, endColumn: 8, childrenStart: 2, childrenCount: 1, dataOffset: 0, dataLen: 1 },
      { id: 2, type: 1, parent: 0, startOffset: 9, endOffset: 14, startLine: 2, startColumn: 1, endLine: 2, endColumn: 6, childrenStart: 3, childrenCount: 1, dataOffset: 0, dataLen: 0 },
      { id: 3, type: 10, parent: 1, startOffset: 2, endOffset: 7, startLine: 1, startColumn: 3, endLine: 1, endColumn: 8, childrenStart: 0, childrenCount: 0, dataOffset: 1, dataLen: 8 },
      { id: 4, type: 10, parent: 2, startOffset: 9, endOffset: 14, startLine: 2, startColumn: 1, endLine: 2, endColumn: 6, childrenStart: 0, childrenCount: 0, dataOffset: 9, dataLen: 8 },
    ],
    children: [1, 2, 3, 4],
    typeData,
  });
